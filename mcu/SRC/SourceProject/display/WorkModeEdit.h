...
#define AddrWaterStageV2  0x6688  ///< Адрес положения заслонки этапа (просмотр)
#define AddrWaterTimeoutV  0x668A     ///< Адрес скорости вентилятора этапа (просмотр)
/// @}
...
#define AddrWaterStageE2   0x6788  ///< Адрес положения заслонки этапа (просмотр)
#define AddrWaterTimeoutE  0x678a     ///< Адрес скорости вентилятора этапа (просмотр)
/// @}
